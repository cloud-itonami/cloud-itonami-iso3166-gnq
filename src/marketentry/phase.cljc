(ns marketentry.phase
  "Phase 0->3 staged rollout for the Equatorial Guinea (GNQ)
  ...
  real Commercial Registry (Registro de la Propiedad y Mercantil) /
  Ministry of Commerce business-registration filing package and
